    ...
    <section className="rounded-2xl border border-slate-800 bg-slate-900 p-4 shadow-sm">
      ...
      <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
        <button
          ...
          disabled={isDisabled}
          className="inline-flex items-center justify-center gap-2 rounded-xl border border-emerald-900/50 bg-emerald-900/30 px-4 py-3 text-sm font-semibold text-emerald-400 transition hover:border-emerald-900/80 disabled:cursor-not-allowed disabled:opacity-50"
        >
        ...
        <button
          ...
          disabled={isDisabled}
          className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-800 bg-slate-900 px-4 py-3 text-sm font-semibold text-slate-300 transition hover:border-slate-700 hover:text-slate-100 disabled:cursor-not-allowed disabled:opacity-50"
        >
